...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${ctx}/teacherclass/findBySqlteacher" method="post">
	...
	-->
                <div class="result-content">
                  ...
                  <c:forEach items="${pagers.datas}" var="data" varStatus="l">
	                  <tr>
	                    ...
	                    <td>${data.xw}</td>
	                   <td>
	                        <a class="link-update" href="${ctx}/teacherclass/findBySql?teacherId=${data.id}">授课管理</a>
	                    </td>
	                </tr>
                  </c:forEach>
        ...
        <td colspan="8">
		        <div class="pagelist">
		        <!-- 分页开始 -->
					      <pg:pager  url="${ctx}/teacherclass/findBySqlteacher" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
