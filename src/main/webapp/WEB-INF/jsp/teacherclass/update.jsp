	...
	private String address; -->
        <div class="result-wrap">
            <div class="result-content">
                <form action="${ctx}/teacherclass/exUpdate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                 ...
                 <input type="hidden" name="id" value="${obj.id}">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="bj" size="50" value="${obj.bj}" type="text">
                                </td>
                        </tr>
                         ...
                         <tr>
                                ...
                                <td>
                                    <input type="text" name="xk"  class='ECalendar common-text required' id=""  value="${obj.xk}"/>
                                </td>
                        </tr>
                          <tr>
                                <th><i class="require-red">*</i>上课地点：</th>
                                <td>
                                    <input class="common-text required" id="title" name="address" size="50" value="${obj.address}" type="text">
                                </td>
                        </tr>
                            <tr>
                                <th></th>
