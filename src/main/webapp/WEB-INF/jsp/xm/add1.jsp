	...
	-->
        <div class="result-wrap">
            <div class="result-content">
                <form action="${ctx}/xm/exAdd1" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <SELECT name="workType" style = "width:100px;">
                        ...
                        <tr>
                            <th><i class="require-red">*</i>开始时间：</th>
                             <td>
                                 <input type="text" name="beginDate" class='ECalendar' id="ECalendar_date"  value=""/>
                              </td>
                        </tr>
