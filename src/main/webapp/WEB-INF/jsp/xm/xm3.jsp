...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${ctx}/xm/findBySql3" method="post">
	...
	-->
                <div class="result-content">
                  ...
                  <c:forEach items="${pagers.datas}" var="data" varStatus="l">
	                  <tr>
	                   ...
	                   <td>
	                    <c:if test="${data.status != 9 && data.status != 8}">
	                     <a class="link-update" href="${ctx}/xm/view4?id=${data.id}">查看详情</a>
	                        <a class="link-del" href="${ctx}/xm/delete3?id=${data.id}">删除</a>
	                          <a class="link-del" href="${ctx}/xm/sb3?id=${data.id}">上报审批</a>
	                    </c:if>
        ...
        <td colspan="8">
		        <div class="pagelist">
		        <!-- 分页开始 -->
					      <pg:pager  url="${ctx}/xm/findBySql3" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
