...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${ctx}/xm/spfindBySql2" method="post">
	...
	-->
                <div class="result-content">
                  ...
                  <c:forEach items="${pagers.datas}" var="data" varStatus="l">
	                  <tr>
	                   ...
	                   <td>
	                    <c:if test="${data.status ==3 }">
	                        <a class="link-update" href="${ctx}/xm/view2?id=${data.id}">去审批</a>
	                     </c:if>
        ...
        <td colspan="8">
		        <div class="pagelist">
		        <!-- 分页开始 -->
					      <pg:pager  url="${ctx}/xm/spfindBySql2" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
