...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${ctx}/xm/findBySql1" method="post">
	...
	-->
                <div class="result-content">
                  ...
                  <c:forEach items="${pagers.datas}" var="data" varStatus="l">
	                  <tr>
	                   ...
	                   <td>
	                        <a class="link-update" href="${ctx}/xm/update1?id=${data.id}">修改</a>
	                        <a class="link-del" href="${ctx}/xm/delete1?id=${data.id}">删除</a>
	                          <a class="link-del" href="${ctx}/xm/sb1?id=${data.id}">上报审批</a>
	                    </td>
	                </tr>
                  </c:forEach>
        ...
        <td colspan="8">
		        <div class="pagelist">
		        <!-- 分页开始 -->
					      <pg:pager  url="${ctx}/xm/findBySql1" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
