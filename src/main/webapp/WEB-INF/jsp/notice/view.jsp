    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="${ctx}/notice/exAdd" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="${obj.title}" type="text" disabled="disabled">
                                </td>
                        </tr>
                        
                        <tr>
                                <th>内容：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10" disabled="disabled">${obj.content}</textarea></td>
                            </tr>
                        </tbody></table>
                </form>
            </div>
