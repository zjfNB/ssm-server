	...
	-->
        <div class="result-wrap">
            <div class="result-content">
                <form action="${ctx}/teacher/exAdd" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td>
                                <select name="sex" id="catid" class="required">
                         ...
                         <tr>
                                ...
                                <td>
                                    <input type="text" name="xw"  class='ECalendar common-text required' id=""  value=""/>
                                </td>
                        </tr>
                          <tr>
