	...
	-->
        <div class="result-wrap">
            <div class="result-content">
                <form action="${ctx}/login/toUpdate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="username" size="50" value="${obj.username}" type="text" disabled="disabled">
                                </td>
                        </tr>
                         ...
                         <tr>
                                ...
                                <td>
                                    <input type="text" name="xw"  class='ECalendar common-text required' id=""  value="${obj.xw}" disabled="disabled"/>
                                </td>
                        </tr>
                          <tr>
